...
if($_POST){ 
	...
	$icerik = "<p>Ad Soyad: ".$adsoyad."</p><p>Email: ".$email."</p><p>Telefon: ".$country."".$phone."</p><p>Servisler: ".$services."</p><p>Mesaj: ".$aciklama."</p><p>Gönderilen Sayfa: ".$pageurl."</p>";
...
try {
 ...
 $mail->Host = 'smtp.yandex.com.tr';
    ...
    //$mail->addAddress('yunusmaden25@gmail.com', $_POST["name"]); 
